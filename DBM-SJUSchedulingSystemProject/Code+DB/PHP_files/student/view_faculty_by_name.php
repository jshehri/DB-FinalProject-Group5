	...
	<body>
		<ul>
			...
			<li class ="dropdown"><a class="active" href="" class="dropbtn"> Search </a>
				<div class="dropdown-content">
					<a href= "../employee/view_program.php"> College Information </a>
					...
					<a href= "../employee/view_student_by_name.php"> Student </a>
					<a href= "../employee/view_faculty_by_name.php"> Faculty </a>
				</div>
			</li>
